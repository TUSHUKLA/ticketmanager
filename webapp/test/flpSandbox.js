		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TICKET APP",
									"targetURL": "#comtusharproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtusharproject1-display": {
								"semanticObject": "comtusharproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tushar.project1",
									"url": sap.ui.require.toUrl("com/tushar/project1")
								}
							}
						}
					}
